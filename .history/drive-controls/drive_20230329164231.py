...
#     drive_motor(motor1_pwm, M1DIR, GPIO.HIGH, speed, duration)
#     drive_motor(motor2_pwm, M2DIR, GPIO.LOW, speed, duration)
def drive_motor(motor1_pwm, motor1_dir, motor2_pwm, motor2_dir, direction, speed, duration):
...
def drive_forward(speed, duration):
    drive_motor(motor1_pwm, M1DIR, motor2_pwm, M2DIR, GPIO.HIGH, speed, duration)

def drive_backward(speed, duration):
    drive_motor(motor1_pwm, M1DIR, motor2_pwm, M2DIR, GPIO.LOW, speed, duration)
